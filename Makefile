...
demo: $(BIN_DIR)
	$(CC) $(CFLAGS) $(SRC_DIR)/doubly_linked_list.c $(EXAMPLE_DIR)/demo.c -o $(DEMO_TARGET)

test: $(BIN_DIR)
	$(CC) $(CFLAGS) $(SRC_DIR)/doubly_linked_list.c $(TEST_DIR)/test_doubly_list.c -o $(TEST_TARGET)
